export const generateVariantStyle = (theme) => {
  if (!theme) {
    throw new Error('generateVariantStyle requires theme param')
  }
...
export const getVariantsKeys = () => {
  const variants = generateVariantStyle(() => '0 0 0')
  return Object.keys(variants).map((key) => key.slice(1))
}
