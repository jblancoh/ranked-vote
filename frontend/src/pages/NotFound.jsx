      ...
      <div className="max-w-2xl w-full text-center animate-fade-in">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-center mb-4">
            <Search className="text-primary-600 mr-2" size={24} />
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-md mx-auto">
            <Link
              to="/vote"
              className="p-4 bg-gray-50 rounded-lg hover:bg-primary-50 hover:border-primary-200 border-2 border-transparent transition-all duration-200 text-left"
            >
              <div className="text-2xl mb-2">🗳️</div>
              <h3 className="font-bold text-gray-900 mb-1">Votar</h3>
            ...
            >
              ...
              <h3 className="font-bold text-gray-900 mb-1">Acerca de</h3>
              <p className="text-sm text-gray-600">
